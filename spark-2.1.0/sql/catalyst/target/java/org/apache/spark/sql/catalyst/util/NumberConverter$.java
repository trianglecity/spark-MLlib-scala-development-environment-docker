...
public  class NumberConverter$ {
   ...
   */
  private  void decode (long v, int radix, byte[] value)  { throw new RuntimeException(); }
  /**
   ...
   * @param value (undocumented)
   */
  private  long encode (int radix, int fromPos, byte[] value)  { throw new RuntimeException(); }
  /**
   ...
   * @param value (undocumented)
   */
  private  void byte2char (int radix, int fromPos, byte[] value)  { throw new RuntimeException(); }
  /**
   ...
   * @param value (undocumented)
   */
  private  void char2byte (int radix, int fromPos, byte[] value)  { throw new RuntimeException(); }
  /**
