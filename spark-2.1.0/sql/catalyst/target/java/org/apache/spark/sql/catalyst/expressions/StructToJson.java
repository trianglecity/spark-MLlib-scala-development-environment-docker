...
/**
 * Converts a {@link StructType} to a json output string.
 */
public  class StructToJson extends org.apache.spark.sql.catalyst.expressions.UnaryExpression implements org.apache.spark.sql.catalyst.expressions.codegen.CodegenFallback, org.apache.spark.sql.catalyst.expressions.ExpectsInputTypes, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   StructToJson (scala.collection.immutable.Map<java.lang.String, java.lang.String> options, org.apache.spark.sql.catalyst.expressions.Expression child)  { throw new RuntimeException(); }
  ...
  public  Object nullSafeEval (Object row)  { throw new RuntimeException(); }
