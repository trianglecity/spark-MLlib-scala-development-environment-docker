...
public  class SortOrder extends org.apache.spark.sql.catalyst.expressions.UnaryExpression implements org.apache.spark.sql.catalyst.expressions.Unevaluable, scala.Product, scala.Serializable {
  static public  org.apache.spark.sql.catalyst.expressions.SortOrder apply (org.apache.spark.sql.catalyst.expressions.Expression child, org.apache.spark.sql.catalyst.expressions.SortDirection direction)  { throw new RuntimeException(); }
  ...
  // not preceding
  public   SortOrder (org.apache.spark.sql.catalyst.expressions.Expression child, org.apache.spark.sql.catalyst.expressions.SortDirection direction, org.apache.spark.sql.catalyst.expressions.NullOrdering nullOrdering)  { throw new RuntimeException(); }
