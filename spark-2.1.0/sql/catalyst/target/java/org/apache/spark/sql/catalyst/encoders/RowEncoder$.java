...
public  class RowEncoder$ {
  ...
  private  org.apache.spark.sql.catalyst.expressions.Expression serializerFor (org.apache.spark.sql.catalyst.expressions.Expression inputObject, org.apache.spark.sql.types.DataType inputType)  { throw new RuntimeException(); }
  /**
  ...
  private  org.apache.spark.sql.catalyst.expressions.Expression deserializerFor (org.apache.spark.sql.types.StructType schema)  { throw new RuntimeException(); }
  private  org.apache.spark.sql.catalyst.expressions.Expression deserializerFor (org.apache.spark.sql.catalyst.expressions.Expression input)  { throw new RuntimeException(); }
  private  org.apache.spark.sql.catalyst.expressions.Expression deserializerFor (org.apache.spark.sql.catalyst.expressions.Expression input, org.apache.spark.sql.types.DataType dataType)  { throw new RuntimeException(); }
}
