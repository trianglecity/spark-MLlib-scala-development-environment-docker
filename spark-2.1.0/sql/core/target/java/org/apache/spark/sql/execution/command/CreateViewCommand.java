...
public  class CreateViewCommand extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.execution.command.RunnableCommand, scala.Product, scala.Serializable {
   ...
   * @param sparkSession (undocumented)
   * @param aliasedPlan (undocumented)
   * @return (undocumented)
   */
  private  org.apache.spark.sql.catalyst.catalog.CatalogTable prepareTable (org.apache.spark.sql.SparkSession sparkSession, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan aliasedPlan)  { throw new RuntimeException(); }
}
