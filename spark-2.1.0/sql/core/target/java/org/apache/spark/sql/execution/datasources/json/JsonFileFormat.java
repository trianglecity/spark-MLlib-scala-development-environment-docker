...
public  class JsonFileFormat extends org.apache.spark.sql.execution.datasources.TextBasedFileFormat implements org.apache.spark.sql.sources.DataSourceRegister {
  ...
  private  org.apache.spark.rdd.RDD<java.lang.String> createBaseRdd (org.apache.spark.sql.SparkSession sparkSession, scala.collection.Seq<org.apache.hadoop.fs.FileStatus> inputPaths)  { throw new RuntimeException(); }
