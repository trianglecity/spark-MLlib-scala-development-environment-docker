...
public  class InsertIntoHadoopFsRelationCommand extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.execution.command.RunnableCommand, scala.Product, scala.Serializable {
  ...
  public  scala.Function1<scala.collection.Seq<scala.collection.immutable.Map<java.lang.String, java.lang.String>>, scala.runtime.BoxedUnit> refreshFunction ()  { throw new RuntimeException(); }
  ...
  // not preceding
  public   InsertIntoHadoopFsRelationCommand (org.apache.hadoop.fs.Path outputPath, scala.collection.immutable.Map<java.lang.String, java.lang.String> staticPartitionKeys, scala.collection.immutable.Map<scala.collection.immutable.Map<java.lang.String, java.lang.String>, java.lang.String> customPartitionLocations, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> partitionColumns, scala.Option<org.apache.spark.sql.catalyst.catalog.BucketSpec> bucketSpec, org.apache.spark.sql.execution.datasources.FileFormat fileFormat, scala.Function1<scala.collection.Seq<scala.collection.immutable.Map<java.lang.String, java.lang.String>>, scala.runtime.BoxedUnit> refreshFunction, scala.collection.immutable.Map<java.lang.String, java.lang.String> options, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan query, org.apache.spark.sql.SaveMode mode, scala.Option<org.apache.spark.sql.catalyst.catalog.CatalogTable> catalogTable)  { throw new RuntimeException(); }
   ...
   */
  private  void deleteMatchingPartitions (org.apache.hadoop.fs.FileSystem fs, org.apache.hadoop.fs.Path qualifiedOutputPath)  { throw new RuntimeException(); }
}
