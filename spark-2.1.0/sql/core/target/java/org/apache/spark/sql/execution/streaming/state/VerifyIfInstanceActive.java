...
public  class VerifyIfInstanceActive implements org.apache.spark.sql.execution.streaming.state.StateStoreCoordinatorMessage, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   VerifyIfInstanceActive (org.apache.spark.sql.execution.streaming.state.StateStoreId storeId, java.lang.String executorId)  { throw new RuntimeException(); }
}
