...
public  class InsertIntoDataSourceCommand extends org.apache.spark.sql.catalyst.plans.logical.LeafNode implements org.apache.spark.sql.execution.command.RunnableCommand, scala.Product, scala.Serializable {
  ...
  public  org.apache.spark.sql.catalyst.plans.logical.OverwriteOptions overwrite ()  { throw new RuntimeException(); }
  // not preceding
  public   InsertIntoDataSourceCommand (org.apache.spark.sql.execution.datasources.LogicalRelation logicalRelation, org.apache.spark.sql.catalyst.plans.logical.LogicalPlan query, org.apache.spark.sql.catalyst.plans.logical.OverwriteOptions overwrite)  { throw new RuntimeException(); }
