...
public  class FileSourceScanExec extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.DataSourceScanExec, scala.Product, scala.Serializable {
  ...
  public  scala.collection.Seq<org.apache.spark.sql.sources.Filter> dataFilters ()  { throw new RuntimeException(); }
  public  scala.Option<org.apache.spark.sql.catalyst.TableIdentifier> metastoreTableIdentifier ()  { throw new RuntimeException(); }
  // not preceding
  public   FileSourceScanExec (org.apache.spark.sql.execution.datasources.HadoopFsRelation relation, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> output, org.apache.spark.sql.types.StructType outputSchema, scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Expression> partitionFilters, scala.collection.Seq<org.apache.spark.sql.sources.Filter> dataFilters, scala.Option<org.apache.spark.sql.catalyst.TableIdentifier> metastoreTableIdentifier)  { throw new RuntimeException(); }
  ...
  private  java.lang.String doProduceVectorized (org.apache.spark.sql.catalyst.expressions.codegen.CodegenContext ctx)  { throw new RuntimeException(); }
