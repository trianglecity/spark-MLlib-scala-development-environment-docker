...
public  class UIUtils {
  ...
  static public  scala.collection.Seq<scala.xml.Node> makeProgressBar (int started, int completed, int failed, int skipped, int killed, int total)  { throw new RuntimeException(); }
